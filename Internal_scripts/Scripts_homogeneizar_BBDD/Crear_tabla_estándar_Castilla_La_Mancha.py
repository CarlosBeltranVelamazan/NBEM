...
def ToledoDB(archivo):
        ...
        second_column = df.pop('C.P.')
        df.insert(1, 'CP', second_column) 
        df.insert(2, 'CCAA', "Castilla La Mancha")
        df.insert(3, 'PROV', "Toledo") 
        df.insert(4, 'CMUN', "") 
        df.insert(5, 'Municipio', "") 
        df.insert(6, 'Coordenadas_latitud', "") 
        df.insert(7, 'Coordenadas_longitud', "") 
        df.insert(8, 'ZonaClimatica', "") 
        fifth_column = df.pop('Nº Registro')
        df.insert(9, 'NumeroCertificado', fifth_column) 
        sixth_column = df.pop('Tipo Edificio')
        df.insert(10, 'TipoEdificio', sixth_column) 
        df.TipoEdificio.replace ({"Vivienda unifamiliar":"Residencial - Vivienda unifamiliar", "Vivienda  individual en bloque":"Residencial - Vivienda individual", "Bloque de vivienda completo":"Residencial - Bloque completo", "Local uso terciario":"Terciario - Local", "Edificio uso terciario":"Terciario - Edificio completo"}, inplace=True)
        seventh_column = df.pop('Tipo Certificación')
        ...
        df.insert(15, 'Consumo_energía_primaria', "") # Consumo_energía_primaria (kWh/m2año)
        ...
        df.insert(17, 'Emisiones_CO2', "") # Emisiones CO2 (kgCO2/m2año)
        ...
        df.insert(38, 'Fecha_registro', df ['Fecha Inscripción'].str[-4:])
        ...
        df['Fecha Inscripción'] = pd.to_datetime(df['Fecha Inscripción'].str.strip(), dayfirst=True, errors = 'coerce')
        df.sort_values(by='Fecha Inscripción',ascending=False, inplace=True)
